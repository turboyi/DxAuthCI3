...
$config['DX_email_activation'] = FALSE; //TRUE; 
...
$config['DX_max_login_attempts'] = 5; //3
...
$config['DX_captcha_width'] = 160;//320;
$config['DX_captcha_height'] = 32;//95;
$config['DX_captcha_font_size'] = '24'; 
$config['DX_captcha_grid'] = TRUE;
$config['DX_captcha_expire'] = 180; 
$config['DX_captcha_case_sensitive'] = FALSE; //TRUE;
...
// Registration
$config['DX_allow_registration'] = FALSE;//TRUE; 
$config['DX_captcha_registration'] = FALSE;//TRUE;
